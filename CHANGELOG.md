...
* \[maven-release-plugin] prepare release 1\_0\_3 (itorders@jahia.com)
...
* \[maven-release-plugin] prepare release 1\_0\_2 (bamboo@jahia.com)
...
* \[maven-release-plugin] prepare release 1\_0\_1 (itorders@jahia.com)
...
* \[maven-release-plugin] prepare release 1\_0\_0 (itorders@jahia.com)
...
* Shorten Content Editor toolbar label for managing vanity URLs (#373)

### Bug Fixes

* Remove deprecated Dropdown label prop (#375)

* Set description length to 240 (#355)
