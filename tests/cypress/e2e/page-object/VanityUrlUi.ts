...
export class VanityUrlUi extends BasePage {
    ...
    addFirstVanityUr(vanityValue : string, canonical : boolean = false) {
        ...
        if(canonical){   cy.get('span[data-vud-role="default"]').find('input').click()  }
    ...
    checkVanityUrlDefaultBadge(vanityValue : string){
